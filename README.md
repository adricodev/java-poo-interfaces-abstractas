...
|---|---|
| [Ejercicio 01](src/ejercicio01/README.md) | Crear una clase abstracta `Figura` con metodo abstracto `calcularArea()`. Implementar `Circulo` y `Rectangulo`. |
| [Ejercicio 02](src/ejercicio02/README.md) | Crear una interface `Volador` con metodos `abstract`, `default` y `static`. Implementar `Pajaro` y `Avion`. |
